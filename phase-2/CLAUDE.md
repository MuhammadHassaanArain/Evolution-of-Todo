...
## Active Technologies
- Python 3.13+ (as required by constitution) + None required beyond standard library (001-todo-cli)
- N/A (in-memory only as required by constitution) (001-todo-cli)
- Python 3.13+ (backend), TypeScript/JavaScript (frontend), Next.js 16+ + FastAPI (backend), Next.js (frontend), Better Auth (authentication), SQLModel (ORM), Neon Serverless PostgreSQL (database) (002-phase-ii-arch)
- Neon Serverless PostgreSQL for persistent data storage (002-phase-ii-arch)
- JWT-based authentication with stateless tokens (002-phase-ii-arch)
- SQLModel ORM for database operations (002-phase-ii-arch)
- Tailwind CSS for responsive UI (002-phase-ii-arch)
